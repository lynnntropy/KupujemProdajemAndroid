 ...
 */
public class StyledSpinnerCategoryAdapter extends ArrayAdapter<WebsiteHandler.Category>
{
    private final Context context;
    private final List<WebsiteHandler.Category> values;
    ...
    public StyledSpinnerCategoryAdapter(Context context, List<WebsiteHandler.Category> values)
    {
