 ...
 */
public class StyledSpinnerGenericAdapter extends ArrayAdapter<WebsiteHandler.GenericID>
{
    private final Context context;
    private final List<WebsiteHandler.GenericID> values;
    ...
    public StyledSpinnerGenericAdapter(Context context, List<WebsiteHandler.GenericID> values)
    {
